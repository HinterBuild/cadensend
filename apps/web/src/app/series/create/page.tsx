...
const briefSchema = z.object({
  ...
  citationReq: z.enum(['required', 'optional']).default('required'),
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div className="flex justify-end space-x-4">
            <Link href="/dashboard">
              <button type="button" className="px-4 py-2 text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200">
                Cancel
              </button>
            </Link>
            <button
